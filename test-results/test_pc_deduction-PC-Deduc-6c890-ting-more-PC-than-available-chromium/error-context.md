...
- status: "Action Phase Round 1 - Choose your actions A Alice PC: 15 | Office: State Senator ⚡ 2 AP"
- main:
  - heading "Action Phase" [level=3]
  - paragraph: You have 2 action points remaining.
  - button "🎭 View Identity"
- log:
  - text: Charlie becomes a Media Darling! They gain 5 PC and are immune to the next Scandal event.
  - button "Show Full Game Log": More

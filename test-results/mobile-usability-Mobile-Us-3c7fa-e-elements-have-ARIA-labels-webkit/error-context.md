...
- status: "Action Phase Round 1 - Choose your actions P Player 1 PC: 28 | Office: None ⚡ 2 AP"
- heading "Action Phase" [level=3]
- paragraph: You have 2 action points remaining.
- button "🎭 View Identity"
- log: "EVENT: Last Bill Was a Dud! \"The last player to successfully sponsor legislation loses 10 PC. Move Public Mood -1.\" Player 1 (outsider) gains 3 PC from worsened public mood. Player 2 (incumbent) loses 3 PC from worsened public mood. No legislation was successfully sponsored recently, so this event has no target."
...
- text: Game started successfully. It is now Player 1's turn.
```
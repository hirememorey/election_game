...
- status: "Action Phase Round 1 - Choose your actions P Player 1 PC: 20 | Office: State Senator ⚡ 2 AP"
- heading "Action Phase" [level=3]
- paragraph: You have 2 action points remaining.
- button "🎭 View Identity"
- log: "EVENT: Economic Boom \"Move Public Mood +2 spaces. All players gain 5 PC.\" Player 1 (incumbent) gains 5 PC from improved public mood. Player 2 (outsider) loses 5 PC from improved public mood."

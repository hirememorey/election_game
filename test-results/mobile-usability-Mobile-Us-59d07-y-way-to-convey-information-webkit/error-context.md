...
- status: "Action Phase Round 1 - Choose your actions 4 rounds until Legislation Phase P Player 1 PC: 25 | Office: None ⚡ 2 AP"
- heading "Action Phase" [level=3]
- paragraph: You have 2 action points remaining.
- button "🎭 View Identity"
- log: "EVENT: War Breaks Out \"Public Mood is locked at its current position for the rest of the Term. All legislation requires 2 additional PC to pass until the Term ends.\" War has broken out! Public Mood is locked and legislation faces a -2 penalty for the rest of the term."

...
- status: "Action Phase Round 1 - Choose your actions 4 rounds until Legislation Phase P Player 1 PC: 35 | Office: None ⚡ 2 AP"
- heading "Action Phase" [level=3]
- paragraph: You have 2 action points remaining.
- button "🎭 View Identity"
- log: "EVENT: Grassroots Movement \"The player with the fewest held offices (0 is fewest) gains 10 PC.\" Player 1, with the fewest offices, gains 10 PC from the grassroots movement."

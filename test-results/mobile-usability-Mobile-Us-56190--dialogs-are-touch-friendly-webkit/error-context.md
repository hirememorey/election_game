...
- status: "Action Phase Round 1 - Choose your actions 4 rounds until Legislation Phase P Player 1 PC: 32 | Office: None ⚡ 2 AP"
- heading "Action Phase" [level=3]
- paragraph: You have 2 action points remaining.
- button "🎭 View Identity"
- log: "EVENT: Technological Leap \"Move Public Mood +1. The player with the least PC gains 10 PC.\" Player 1 (outsider) loses 3 PC from improved public mood. Player 2 (outsider) loses 3 PC from improved public mood. Player 1, with the least PC, gains 10 PC from the technological leap."

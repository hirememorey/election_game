...
- status: "Action Phase Round 1 - Choose your actions B Bob PC: 22 | Office: None ⚡ 2 AP"
- heading "Action Phase" [level=3]
- paragraph: You have 2 action points remaining.
- button "🎭 View Identity"
- log: Alice sponsored the Protect The Children!. This legislation will be voted on during the end-of-term legislation session. Bob's turn.

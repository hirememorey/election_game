...
- status: "Action Phase Round 1 - Choose your actions P Player 1 PC: 30 | Office: None ⚡ 2 AP"
- heading "Action Phase" [level=3]
- paragraph: You have 2 action points remaining.
- button "🎭 View Identity"
- log: "EVENT: Media Darling \"Choose one player. They gain 5 PC and are immune to the next 'Scandal!' event.\" Player 1 becomes a Media Darling! They gain 5 PC and are immune to the next Scandal event."

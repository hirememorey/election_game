...
- banner:
  ...
  - button "Game Info": ⓘ
  - button "Menu": ☰
- text: "Action Phase Round 1 - Choose your actions T Test Player 1 PC: 22 | Office: None ⚡ 2 AP"
...
- button "🎭 View Identity"
- text: Test Player 2, with the least PC, gains 10 PC from the technological leap.
- button "More"
- contentinfo
```
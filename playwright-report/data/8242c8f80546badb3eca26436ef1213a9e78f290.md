...
- banner:
  ...
  - button "Game Info": ⓘ
  - button "Menu": ☰
- text: "Action Phase Round 1 - Choose your actions T Test Player 1 PC: 18 | Office: State Senator ⚡ 2 AP"
...
- button "🎭 View Identity"
- text: No legislation was successfully sponsored recently, so this event has no target.
- button "More"
- contentinfo
```